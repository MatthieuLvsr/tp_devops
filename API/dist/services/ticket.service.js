...
var TicketService = /** @class */ (function () {
    function TicketService() {
        this.ticketModel = models_1.TicketModel;
    }
    TicketService.prototype.createTicket = function (ticket) {
        return __awaiter(this, void 0, void 0, function () {
            var createdTicket, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.ticketModel.create({
                                type: ticket.type,
                    ...
                    case 1:
                        createdTicket = _a.sent();
                        return [2 /*return*/, createdTicket];
                    case 2:
                        error_1 = _a.sent();
